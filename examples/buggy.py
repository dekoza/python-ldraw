...
print(Piece(Yellow, Vector(0, 72, -320), Identity(), Baseplate16X16))
print(Piece(Blue, Vector(320, 72, 0), Identity(), Baseplate16X16))
print(Piece(Blue, Vector(320, 72, -320), Identity(), Baseplate16X16))
